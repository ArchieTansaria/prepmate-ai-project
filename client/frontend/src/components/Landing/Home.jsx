...
import image from "../../assets/landing-image-2.png";
			...
			>
				...
				<div className="font-[Manrope] text-center z-10 px-4">
					...
					<div className="flex justify-center space-x-4">
						<button className="px-6 py-3 bg-white text-black font-[Poppins] font-semibold rounded-full focus:outline-none hover:shadow-lg hover:scale-105 transition">
							Start Generating🚀
						</button>
						<button className="px-6 py-3 text-white font-bold fon-[Poppins] rounded-full border border-gray-200 hover:shadow-md hover:shadow-white transition duration-100 focus:outline-none">
							Login
						</button>
					</div>
				</div>
